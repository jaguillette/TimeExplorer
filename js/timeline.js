...
function TL_Error(t, e) {
    ...
    function(t) {
        var e = function() {
            ...
            return G.matches = function(t, e) {
                ...
                var n, a, o;
                return A.test(t) && (n = $(S.createElement(RegExp.$1))), n || (t.replace && (t = t.replace(j, "<$1></$2>")), e === L && (e = U.test(t) && RegExp.$1), e in H || (e = "*"), o = H[e], o.innerHTML = "" + t, n = $.each(M.call(o.childNodes), function() {
                    o.removeChild(this)
                ...
                if (!t) return G.Z();
                if ("string" == typeof t)
                    if (t = t.trim(), "<" == t[0] && U.test(t)) n = G.fragment(t, RegExp.$1, i), t = null;
                    else {
                    ...
                    else if (U.test(t)) n = G.fragment(t.trim(), RegExp.$1, i), t = null;
                    else {
                        if (i !== L) return $(i).find(t);
                        n = G.qsa(S, t)
                    }
    ...
    function() {
        var t = navigator.userAgent.toLowerCase(),
            ...
            n = t.indexOf("webkit") !== -1,
            a = t.indexOf("phantom") !== -1,
            s = t.search("android [23]") !== -1,
        ...
        function a(a, d, u, m, _) {
            ...
            if (r || n(), d)
                if (d = "string" == typeof d ? [d] : d.concat(), w || r.async || r.gecko || r.opera) c[a].push({
                    ...
                    for (f = 0, p = d.length; f < p; ++f) c[a].push({
                        urls: [d[f]],
            ...
            if (!h[a] && (v = h[a] = c[a].shift())) {
                for (l || (l = t.head || t.getElementsByTagName("head")[0]), y = v.urls, f = 0, p = y.length; f < p; ++f) T = y[f], w ? g = r.gecko ? e("style") : e("link", {
                    href: T,
                    rel: "stylesheet"
                }) : (g = e("script", {
                    src: T
                ...
                for (f = 0, p = b.length; f < p; ++f) l.appendChild(b[f])
            }
        }
        ...
        getLatestDate: function() {
            ...
            for (var e = 0; e < this.eras.length; e++) this.eras[e].end_date ? t.push({
    ...
    function(t) {
            ...
            l = function(i, n) {
                ...
                if (s) {
                    ...
                    if (a = new t.TimelineConfig(r), r.errors)
                        for (var l = 0; l < r.errors.length; l++) a.logError(r.errors[l]);
                    n(a)
                } else t.ajax({
                    url: i,
                    dataType: "json",
                    ...
                    error: function(e, i, s) {
                        if (a = new t.TimelineConfig, "parsererror" == i) var s = new t.Error("invalid_url_err");
                        else var s = new t.Error("unknown_read_err", i);
                        a.logError(s), n(a)
                    }
                })
            };
        ...
        function a(t, e) {
            var i, n = {};
            return (i = t.match(E)) && (n.rotate = f(i[1], e ? e.rotate : null)), (i = t.match(S)) && (n.scale = f(i[1], e ? e.scale : null)), (i = t.match(C)) && (n.skewx = f(i[1], e ? e.skewx : null), n.skewy = f(i[3], e ? e.skewy : null)), (i = t.match(N)) && (n.translatex = f(i[1], e ? e.translatex : null), n.translatey = f(i[3], e ? e.translatey : null)), n
        }
        ...
        function u(t, e) {
            ...
            for (n = 1; n < a; ++n)
                for (i = 0; i < a - n; ++i) s[i][0] = (1 - e) * s[i][0] + e * s[parseInt(i + 1, 10)][0], s[i][1] = (1 - e) * s[i][1] + e * s[parseInt(i + 1, 10)][1];
            return [s[0][0], s[0][1]]
        }
        ...
        function p(t, e) {
            ...
            for (v && (n = e.left, o = e.top, delete e.right, delete e.bottom, delete e.left, delete e.top), i = d.length; i--;) {
                ...
                for (var E in e) {
                    ...
                    var S, C = j(d[i], E),
                        N = h(e[E]) ? e[E](d[i]) : e[E];
                    "string" != typeof N || !k.test(N) || k.test(C) ? (y[i][E] = "transform" == E ? a(C) : "string" == typeof N && k.test(N) ? r(C).slice(1) : parseFloat(C), T[i][E] = "transform" == E ? a(N, y[i][E]) : "string" == typeof N && "#" == N.charAt(0) ? r(N).slice(1) : f(N, parseFloat(C)), "string" == typeof N && (S = N.match(M)) && (L[i][E] = S[1])) : delete e[E]
                }
            }
            return c.apply(d, [p, function(t, n, a) {
                for (i = d.length; i--;) {
                    v && (a = u(w[i], t), d[i].style.left = a[0] + "px", d[i].style.top = a[1] + "px");
                    for (var o in e) n = _(t, L, y, T, o, i), "transform" == o ? d[i].style[U] = s(n) : "opacity" != o || A ? d[i].style[l(o)] = n : d[i].style.filter = "alpha(opacity=" + 100 * n + ")"
                }
            }, m, g])
        }
        var g = document,
        ...
        return O(function(t) {
            b = t > 1e12 != L() > 1e12
        }), p.tween = c, p.getStyle = j, p.bezier = u, p.transform = U, p.parseTransform = a, p.formatTransform = s, p.easings = {}, p
    ...
    function(t) {
        ...
        createMedia: function() {
            ...
            (this.data.url.match(/.png(\?.*)?$/) || this.data.url.match(/.svg(\?.*)?$/)) && (e = "tl-media-item tl-media-image"), this.data.link ? (this._el.content_link = TL.Dom.create("a", "", this._el.content), this._el.content_link.href = this.data.link, this._el.content_link.target = "_blank", this._el.content_item = TL.Dom.create("img", e, this._el.content_link)) : this._el.content_item = TL.Dom.create("img", e, this._el.content), this._el.content_item.addEventListener("load", function(e) {
                t.onMediaLoaded()
...
TL.Media.SoundCloud = TL.Media.extend({
        ...
        _positionEras: function(t) {
            for (var e = 0, i = 0; i < this._eras.length; i++) {
                ...
                n.start = this.timescale.getPosition(this._eras[i].data.start_date.getTime()), n.end = this.timescale.getPosition(this._eras[i].data.end_date.getTime()), n.width = n.end - n.start, t ? this._eras[i].setClass("tl-timeera tl-timeera-fast") : this._eras[i].setClass("tl-timeera"), this._eras[i].setPosition({
                    left: n.start
        ...
        _getTicks: function(t, e) {
            for (var i = t._scaled_padding * e.factor, n = t._earliest - i, a = t._latest + i, s = [], o = n; o < a; o += e.factor) s.push(t.getDateFromTime(o).floor(e.name));
            return {
                name: e.name,
                ticks: s
            }
